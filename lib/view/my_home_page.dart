    ...
    return SafeArea(
      child: Scaffold(
        body: BackdropFilter(
          ...
          child: FutureBuilder(
            future: Future.delayed(Duration(seconds: 1)), // Simulate loading for 1 second
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () => Get.to(FullScreen(imageUrl: controller.imageList[index].largeImageURL!)),
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 4), // Add spacing between likes and comments
                                Text(
                                  'Comments: ${controller.imageList[index].comments}',
                                  textAlign: TextAlign.center,
                                ),
                              ],
                            ),
